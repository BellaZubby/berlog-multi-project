...
const Facts = (props: Props) => {
  return (
          ...
          <Image src={factsImage} alt='factImage' className='h-64 object-cover'/>
          ...
          <BgMobileAsset className='mobileClip w-[75px]  sm:w-[100px] h-20 bg-primary-300 absolute top-0'/>
          <BgMobileAsset className='mobileClipTwo w-[75px] sm:w-[100px] h-20 bg-primary-300 absolute bottom-0 right-0'/>
          </div>
